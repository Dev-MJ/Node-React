...
passport.use(new FacebookStrategy({
        ...
        clientID: "358467961199599", //앱 ID
        clientSecret: "9465914865b5f3a38afbb94f20a32678", //앱 시크릿 코드
        callbackURL: "http://localhost:3000/auth/facebook/callback",    //아이디 입력 후 이동
...
router.get('/facebook', passport.authenticate('facebook', { scope: 'email'}) ); //facebook strategy 사용하겠다
